...
public class GymChainInfo {
    ...
    public static final String BJ_GYM = "BJ Gym";
    public static final String MEMBER_NAME = "Ronnie";
    ...
    private static void loadMembers(GymChain chain){
        ...
        Member m4 = new Member(MEMBER_NAME);
