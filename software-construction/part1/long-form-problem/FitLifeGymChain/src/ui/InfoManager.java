...
public class InfoManager {
    ...
    private static final String BJ_GYM_COMMAND = "bj";
    ...
    private void printInstructions(){
        ...
        System.out.println("Enter '" + BJ_GYM_COMMAND + "' for Fitlife " + BJ_GYM);
    ...
    private void registerMemberForClass(Member m, FitnessClass fc){
        ...
        if (eligible) {
            ...
            System.out.println(m.getName() + " is not eligible.");
        ...
        if (str.length() > 0) {
            switch (str) {
                ...
                case PALM_LAKE_COMMAND:
                    ...
                    break;
                case BJ_GYM_COMMAND:
                    printGymInfo(chain.lookupGymByName(BJ_GYM));
                    break;
